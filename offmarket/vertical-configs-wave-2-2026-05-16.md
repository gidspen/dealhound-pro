# Wave 2 Vertical Configurations — 2026-05-16
...
- **Tertiary:** Google "[city] pool service" + "[city] pool maintenance" + crawl websites. Filter for "weekly service" / "route service" / "residential pool service."
...
- **Exclude national chains:**
  ...
  - **Pinch A Penny** (franchise-only, can include franchisees if owner is independent)
  - **Aqua-Tots** (no, that's swim school)
  - **Leslie's Pool Supplies service arm** (chain)
- **Exclude pool construction-only** companies (different business model — exclude unless they have service arm).
...
- "equipment repair," "pump replacement," "filter cartridge service" (recurring component).
- "commercial pool service," "HOA pool service," "apartment pool service" (recurring contract clients).
...
- No autopay / no recurring billing software visible (Field Routes, Pool Office Manager, Pool Service Manager = modern; QuickBooks-only = aging).
- No social media / no Facebook with service photos.
- No "we're hiring" / "tech wanted" postings.
- Reviews flat or declining.
...
- **PE-backed national consolidators:**
  ...
  - **USA Pool Services** (PE)
  - **BluPool** (regional PE roll-up)
  - **Premier Pool & Spa**
  - **PoolCorp** (public, supply distribution, also services component)
- **Strategic / equipment-driven acquirers:**
  - **Hayward** (acquires service shops for equipment install distribution)
  - **Pentair** (similar)
- **TX-active:**
  - **Texas Pool Patrol**
  - **Aqua Crystal Pool Services**
- **SBA 7(a) financeability:** YES, top-quartile for service-trade SBA.
- **ETA / search-fund appetite:** RISING (recurring revenue + Sun Belt growth).
...
- Per-account revenue: $1,400-$2,200/yr residential; $4,000-$15,000/yr commercial.
...
- **Austin metro:** +3
- **San Antonio metro:** +0
- **Hill Country (Comal, Hays, Burnet):** +3 (lake/pool homes)
- **Coastal TX:** +0
- **Rural TX:** -5
...
- **Tertiary:** Google Business Profile crawl. Cross-check against franchise directories:
  - **Precision Door Service** locator (Authority Brands franchise)
  - **Aaron Overhead Door**
  - **Mr. Garage Door** (franchise)
...
- **Exclude franchise locations:**
  ...
  - **Aaron Overhead Door**
  - **A1 Garage Service** (PE-backed)
  - **Mr. Garage Door** (franchise)
  - **Overhead Door brand company-owned**
  - **Wayne Dalton brand company-owned**
- **Exclude door-mfg companies** (Wayne Dalton, Clopay, Amarr, C.H.I. Overhead Doors).
...
- No "Member" / "Maintenance Plan" / recurring service program on offer.
- Phone-only intake.
- No FieldEdge / ServiceTitan / Jobber / Housecall Pro visible.
- Owner is also a tech.
- Reviews flat.
...
- **PE-backed national consolidators (VERY HOT):**
  ...
  - **Authority Brands' Precision Door** (Apax Partners)
  - **Wrench Group's garage door arm** (Leonard Green)
  - **AmeriPro Holdings**
- **TX-active platforms:**
  - **Texas Garage Door** group (regional consolidator)
- **SBA 7(a) financeability:** YES, top-quartile.
- **ETA / search-fund appetite:** VERY HIGH (recurring + needs-based + asset-light).
...
- **Secondary:** Texas Nursery & Landscape Association (TNLA) member directory `tnlaonline.org/find-a-member/`.
...
- **Exclude PE-backed national chains:**
  ...
  - **Yellowstone Landscape** (KKR-backed)
  - **Juniper Landscaping** (Pamlico Capital)
  - **LandCare** (BG Strategic)
  - **U.S. Lawns** (franchise — exclude franchise locations but include independent franchisees if independently owned)
  - **The Grounds Guys** (Neighborly franchise — same logic)
  - **Caliber Collision's landscape arm** (Omers)
- **Exclude residential-only mow-and-go** (no commercial book, too small for SBA).
...
- "irrigation service contract," "tree care program," "annual flower rotation."
- "snow removal" (rare in TX but valuable when present).
...
- No LMN, Aspire, RealGreen Lite, Service Autopilot, Jobber visible.
- Phone-only intake.
- Owner still in field.
...
- **PE-backed national consolidators:**
  ...
  - **Juniper** (Pamlico)
  - **LandCare** (BG Strategic)
  - **Park West Companies** (Bow River Capital)
  - **Massey Services' landscape arm**
- **SBA 7(a) financeability:** YES.
- **ETA / search-fund appetite:** HIGH.
...
- **Exclude franchise locations:**
  ...
  - **Five Star Painting** (Neighborly franchise)
  - **House Painters Inc** (franchise)
- **Exclude paint-only companies** (Sherwin-Williams, Benjamin Moore retail are paint retailers, not contractors).
...
- "annual paint maintenance contract" (rare but valuable).
...
- **PE-backed national consolidators (rising):**
  ...
  - **Painting Industry Plus**
  - **Five Star Painting / Neighborly**
- **TX-active regional:**
  - **Wright Brothers Painting** (regional consolidator)
- **SBA 7(a):** YES.
- **ETA appetite:** RISING.
...
- **Houston:** +3
- **SA:** +0
- **Premium-resi-heavy (Sugar Land, Plano, Westlake):** +3
