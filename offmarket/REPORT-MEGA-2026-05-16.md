...
- DCAD, TAD, BCAD — Cloudflare + interactive JS, require Playwright drivers (already built per scrapers/scrape\_\*.py)
...
_Generated 2026-05-16 by the Off-Market Acquisition Scorer skill in autonomous 19-hr mode. Orchestrator: Claude Opus 4.7. Sub-agents: Claude Sonnet 4.6._
